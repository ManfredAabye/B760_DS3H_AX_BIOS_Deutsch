...
### **Die ErP-Funktion** (Energy-related Products) ist eine Einstellung im BIOS, die sicherstellt, dass das System im S5-Zustand (kompletter Ausschaltzustand) den geringstmöglichen Stromverbrauch hat. 
